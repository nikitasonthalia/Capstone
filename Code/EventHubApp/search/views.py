...
def getprofile(request):
    ...
    return render(request, 'listservice.html', {'profiles' : profiles, 'category' : category, 'list1' : list1})
...
#     category = Category.objects.get(category_id = category_id)
    ...
    range1 = range(1,6)
    return render(request, 'viewdetail.html', {'range' : range1 , 'profile' : profile, 'profileDetails':profile_detail, 'list1':list1})
